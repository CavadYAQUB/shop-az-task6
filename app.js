...
for(let btn of buttons){
    btn.onclick=function (e) {
        e.preventDefault();
          ...
          let  exist_product=basket.find(pr=>pr.Id==pr_id);
          if (exist_product===undefined) {
            basket.push({
              ...
              document.querySelector('#alert p').innerHTML='sebete elave olundu'
              document.getElementById('alert').style.right='20px'
          }else{
             exist_product.Count++;
             document.querySelector('#alert p').innerHTML='sebete artiq elave olunub'
              document.getElementById('alert').style.right='20px'
